...
class Level1Medium : GameObject
{
    ...
    private void handleBoneSlideScene()
    {
        ...
        if (_boneslide == null)
        {
            _boneslide = new BoneSlide(((MyGame)game).width, ((MyGame)game).height, 2);
            AddChild(_boneslide);
        }
    ...
    private void handleMixAndMatchScene()
    {
        ...
        {
            _mixandmatch = new MixAndMatch(((MyGame)game).width, ((MyGame)game).height, 12);
    ...
    private void handleDigging2Scene()
    {
        ...
        if (_ds2 == null)
        {
            _ds2 = new Diggingsite("diggingsite2medium.png", 23, 1);
            AddChild(_ds2);
            _taptocontinue = new Sprite("taptocontinue.png");
            AddChild(_taptocontinue);
            _taptocontinue.SetXY(650, 690);
    ...
    private void handleQuizScene()
    {
        if (_quiz == null)
        {
            _quiz = new Quiz("quizquesttest2medium.png", "infoQmedium", new Vec2(0, 0), 2);
            AddChild(_quiz);
        }
